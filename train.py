...
def get_data_module(
    ...
    # indexes_dict_path = r"D:/DL/bytedance_indexes/sr=44100,vocals-accompaniment.pkl"
...
if __name__ == "__main__":
    workspace = "./"
    gpus = 1
    #config_yaml = "./4_train/musdb18/configs/accompaniment-vocals,resunet_subbandtime.yaml"
    # config_yaml = "./4_train/musdb18/configs/vocals-accompaniment,resunet_subbandtime.yaml"
    #config_yaml = "./4_train/musdb18/configs/accompaniment-vocals,mobilenet_subbandtime.yaml"
    config_yaml = "./4_train/musdb18/configs/vocals-accompaniment,mobilenet_subbandtime.yaml"
    filename = pathlib.Path(__file__).stem

...
def create_indexes() -> NoReturn:
    ...
    workspace = r"F:\magicAudio4.0\music_source_separation-master\datasets"
    config_yaml = r"F:\magicAudio4.0\music_source_separation-master\scripts\2_create_indexes\musdb18\configs\sr=44100,vocals-accompaniment.yaml"

...
def pack_audios_to_hdf5s() -> NoReturn:
    ...
    dataset_dir = "F:\magicAudio4.0\music_source_separation-master\datasets\musdb18"
    subset = "train"
    split = ""
    hdf5s_dir = "F:\magicAudio4.0\music_source_separation-master\datasets\hdf5s\musdb18\sr=44100,chn=2"
    sample_rate = 44100
    channels = 2
...
if __name__ == "__main__":
    ...
    #     type=str,
    #     required=True,
    #     default=r"F:\magicAudio4.0\music_source_separation-master\datasets\musdb18",
    ...
    #     type=str,
    #     required=True,
    #     default="F:\magicAudio4.0\music_source_separation-master\datasets\hdf5s\musdb18\sr=44100",
    #     help="Directory to write out hdf5 files.",
    # )
    # parser.add_argument("--sample_rate", type=int, required=True, default=44100, help="Sample rate.")
    # parser.add_argument(
    #     "--channels", type=int, required=True, default=2, help="Use 1 for mono, 2 for stereo."
    # )
    # # Parse arguments.
